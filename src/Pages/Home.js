    ...
    <>
      <div class="banner d-flex bg-c jst-c mb-8">
       ...
       <div class="presentation d-flex container mb-8">
            ...
            <div class="col-5 d-flex-c jst-c">
       ...
       <div class="ne d-flex container jst-c mb-8">
            <div class="block d-flex-c align-c col-10 bdr-20">
                <h1 class="title c-vert up mb">NOS ENGAGEMENTS</h1>
                <h2 class="title t2 mb-1">Duis bibendum vitae sed mauris lorem.</h2>
